...
Gem::Specification.new do |s|
  ...
  s.files = ["ext/swift/db/postgres/result.c", "ext/swift/db/postgres/datetime.c", "ext/swift/db/postgres/adapter.c", "ext/swift/db/postgres/typecast.c", "ext/swift/db/postgres/common.c", "ext/swift/db/postgres/main.c", "ext/swift/db/postgres/statement.c", "ext/swift/db/postgres/typecast.h", "ext/swift/db/postgres/common.h", "ext/swift/db/postgres/datetime.h", "ext/swift/db/postgres/result.h", "ext/swift/db/postgres/statement.h", "ext/swift/db/postgres/adapter.h", "ext/swift/db/postgres/extconf.rb", "test/test_ssl.rb", "test/test_adapter.rb", "test/test_encoding.rb", "test/test_async.rb", "test/helper.rb", "lib/swift/db/postgres.rb", "lib/swift-db-postgres.rb", "README.md", "CHANGELOG"]
